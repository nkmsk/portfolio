            ...
            <form id="my_form" method="post" action="{{ route('works.update', $work->id) }}" class="h-adr mt-6 space-y-6" enctype="multipart/form-data">
              ...
              {{-- <div>
                ...
                @if ($work->work_images->isNotEmpty())
                  <div class="my-3">
                    <img src="{{ $work->work_images->first()->image_path }}" class="object-cover shadow-lg">
                    <p class="text-sm">※登録中の画像</p>
                  </div>
                @else ()
                  <div class="my-3">
                ...
                <div class="flex items-center gap-x-3">
                  <input id="input_file" name="image" type="file" accept="image/*" class="file-input file-input-bordered mt-1 w-full max-w-xs" />
