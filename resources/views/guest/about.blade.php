    ...
    <div class="lg:px-6 flex flex-col">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2">
        <div class="col-span-1 my-8">
          <a href="{{ url('/') }}"><img src="{{ asset('image/top/avatar/avatar-01.jpg') }}" alt="" class="rounded-full mx-auto w-32 h-32 shadow-md border-4 border-white transition duration-200 transform hover:scale-110"></a>
        </div>
